...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Sign in — Chandra Gardens",
      },
      {
        property: "og:description",
        content:
          "Access your Chandra Gardens plant orders and cart.",
      },
      {
        property: "og:type",
        content: "website",
      ...
      <div className="w-full max-w-md rounded-3xl glass p-8 shadow-[var(--shadow-soft)]">
        ...
        >
          ...
          <button
            type="submit"
            disabled={busy}
            className="w-full rounded-full bg-primary py-3 font-semibold text-primary-foreground transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {busy
              ? "Please wait…"
              : mode === "signin"
        ...
        {mode !== "reset" && (
          <>
            ...
            <button
              ...
              onClick={google}
              disabled={busy}
              className="flex w-full items-center justify-center gap-2 rounded-full border border-border bg-background/60 py-3 text-sm font-semibold transition hover:bg-primary/5 disabled:cursor-not-allowed disabled:opacity-60"
            >
